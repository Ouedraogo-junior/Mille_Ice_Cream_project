{{-- resources/views/livewire/admin/categories/partials/category-header.blade.php --}}
<div class="bg-white rounded-2xl shadow-sm border border-cyan-100 p-6 md:p-8 mb-8">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 flex items-center gap-3">
